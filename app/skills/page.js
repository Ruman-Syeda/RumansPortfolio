...
export default function SkillsPage() {
  ...
  const softSkills = [
    ...
    },
    {
      ...
      description: "Experience with managing projects and timelines",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
    ...
    },
    {
      ...
      description: "Familiar with Agile methodologies and Scrum",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
            ...
            <div className={styles.softSkillsGrid}>
              {softSkills.map((skill, index) => (
                <motion.div
                  ...
                  whileHover={{ y: -5, boxShadow: "0 0 15px rgba(0, 238, 255, 0.3)" }}
                >
